"""Senf & Seidl disturbance map preprocessing.

Source: https://zenodo.org/record/8202241 and https://zenodo.org/record/7080016
"""
...
def preprocess_senfseidl(input_path: str | Path, output_path: str | Path | None = None) -> gpd.GeoDataFrame:
    """Load and standardise the Senf & Seidl polygons."""
    ...
    gdf = ensure_columns(gdf, "senfseidl")
    if output_path:
